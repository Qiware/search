...
{
    fprintf(stderr, "id:%lu", data->id);
}

static int rtb_data_cmp_cb(const rbt_data_t *data1, const rbt_data_t *data2)
{
...
int main(void)
{
    ...
    for (n=0; n<2; n++) {
        for (idx=SID_BEG; idx<SID_BEG+SID_NUM; ++idx) {
